...
const SslFinlandia = () => {
  ...
  return (
    <div className="w-full flex flex-col">
      {/* header */}
      <SslHeader title={t("sslf_title")} desc={t("ssli_desc")} />
      ...
      <div className="px-4 lg:px-28 lg:grid lg:grid-cols-5 grid-flow-col py-4 lg:py-12 gap-x-8">
        <div className="lg:col-span-3 space-y-8">
          <Ssl
            ...
            title={t("ssli_finland")}
            description={t("ssli_finland_desc")}
            label={t("read_more")}
          />
          <Ssl
            onClickReadMore={onClickReadMore}
            id={2}
            imageUrl={require("../../Assets/finlandmuseum.jpg")}
            title={t("ssli_finland_museum")}
